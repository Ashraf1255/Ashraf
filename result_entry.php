...
<body>
    <div class="container">
        ...
        <div class="diff">
           <a href="admin_file.php">Enter data for different student</a>
        </div>
        <div class="detail">
        ...
        <div class="main1">
            <form action="" method="post">
             <p>1. <?php echo $sub1." "; ?><input type="text" name="sub1" </p>
             <p>2. <?php echo $sub2." "; ?><input type="text" name="sub2"</p>
             <p>3. <?php echo $sub3." "; ?><input type="text" name="sub3"</p>
             <p>4. <?php echo $sub4." "; ?><input type="text" name="sub4"</p>
             <p>5. <?php echo $sub5." "; ?><input type="text" name="sub5"</p>
             <p>6. <?php echo $sub6." "; ?><input type="text" name="sub6"</p>
             <p>7. <?php echo $sub7." "; ?><input type="text" name="sub7"</p>
             <p>8. <?php echo $sub8." "; ?><input type="text" name="sub8"</p>
             <p>9. <?php echo $sub9." "; ?><input type="text" name="sub9"</p>
             <p>10.<?php echo $sub10." "; ?><input type="text" name="sub10"</p>
             <p>11. <?php echo $sub11." "; ?><input type="text" name="sub11"</p>
             <p><?php 
